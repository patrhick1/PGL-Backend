    ...
    # Service imports (UPDATED IMPORTS)
    from podcast_outreach.services.ai.gemini_client import GeminiService
    from podcast_outreach.services.enrichment.social_scraper import SocialDiscoveryService # Renamed
    from podcast_outreach.services.enrichment.data_merger import DataMergerService # Renamed

    # Model imports (UPDATED IMPORTS)
    ...
    # For async_tavily_search if included directly (UPDATED IMPORT)
    from podcast_outreach.services.ai.tavily_client import async_tavily_search # Use the new Tavily client
