import logging
from src.airtable_service import PodcastService
from src.openai_service import OpenAIService
from src.external_api_service import ListenNotesAPIClient, PodscanAPIClient # REMOVE THIS LINE or update if other functions need new clients
...
def process_mipr_podcast_search_listennotes(record_id, stop_flag: Optional[threading.Event] = None):
    ...
    external_api_service = ListenNotesAPIClient() # REMOVE THIS LINE or update if other functions need new clients
    data_processor = DataProcessor()
    podscan_service = PodscanAPIClient()
